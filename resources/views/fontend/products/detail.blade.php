                    ...
                    <div class="mb-2">
                        <div class="card p-5 border-width-2 border-color-1 borders-radius-17">
                            ...
                            <div class="mb-2 pb-0dot5">
                                <a href="{{ route('cart.index') }}" class="btn btn-block btn-primary-dark"><i
                    ...
                    <div id="Description" class="mx-md-2">
                        ...
                        <div class="mx-md-4 pt-1">
                            ...
                            <p>Praesent ornare, ex a interdum consectetur, lectus diam sodales elit, vitae
                                egestas est
                                enim ornare nisl. Nullam in lectus nec sem semper viverra. In lobortis
                                egestas massa.
                                Nam nec massa nisi. Suspendisse potenti. Quisque suscipit vulputate dui quis
                                volutpat.
                                Ut id elit facilisis, feugiat est in, tempus lacus. Ut ultrices dictum
                                metus, a
                                ultricies ex vulputate ac. Ut id cursus tellus, non tempor quam. Morbi porta
                                diam nisi,
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="pt-lg-8 pt-xl-10">
                                        ...
                                        <p class="mb-6">Fusce vitae nibh mi. Integer posuere, libero et
                                            ullamcorper
                                        ...
                                        <p class="mb-6">Integer bibendum aliquet ipsum, in ultrices enim
                                            sodales sed.
                                            Quisque ut urna vitae lacus laoreet malesuada eu at massa.
                                            Pellentesque nibh
                                            augue, pellentesque nec dictum vel, pretium a arcu. Duis eu urna
                                            suscipit,
                                            lobortis elit quis, ullamcorper massa.</p>
                                        <h3 class="font-size-24 mb-3">Fabolous Sound</h3>
                                        <p class="mb-6">Cras rutrum, nibh a sodales accumsan, elit sapien
                                            ultrices
                                            sapien, eget semper lectus ex congue elit. Nullam dui elit,
                                            fermentum a
                                            varius at, iaculis non dolor. In hac habitasse platea dictumst.
                                        </p>
                                    </div>
                                </div>
                                <div class="col-md-6 text-right">
                                    <img class="img-fluid mr-n4 mr-md-n10 mr-xl-n15"
                                        src="../../assets/img/580X580/img1.jpg" alt="Image Description">
                                </div>
                                <div class="col-md-6 text-left">
                                    <img class="img-fluid ml-n4 ml-md-n10 ml-xl-n15"
                                        src="../../assets/img/580X580/img2.jpg" alt="Image Description">
                                </div>
                            ...
                            <ul class="nav flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                                <li class="nav-item text-gray-111 flex-shrink-0 flex-xl-shrink-1">
                                    <strong>SKU:
                                    </strong> <span class="sku"> FW511948218</span>
                                </li>
                                ...
                                <li class="nav-item text-gray-111 flex-shrink-0 flex-xl-shrink-1">
                                    <strong>Tags:</strong> <a href="#" class="text-blue">Fast</a>,
                                    <a href="#" class="text-blue">Gaming</a>, <a href="#"
                    ...
                    <div id="Reviews" class="mx-md-2">
                        ...
                        <div class="mb-4 px-lg-4">
                            ...
                            <div class="pb-4 mb-4">
                                ...
                                <p class="text-gray-90">Sed id tincidunt sapien. Pellentesque cursus accumsan
                                    tellus,
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th class="px-4 px-xl-5">Average Battery Life (in hours)
                                                        </th>
                                                        <td>9</td>
                                                    </tr>
                                                </tbody>
                                ...
                                <div class="tab-pane fade" id="Reviews" role="tabpanel">
                                    <div class="mb-4 px-lg-4">
                                        ...
                                        <div class="border-bottom border-color-1 pb-4 mb-4">
                                            ...
                                            <p class="text-gray-90">Pellentesque habitant morbi tristique senectus
                                                et
                                                netus et
                                                malesuada fames ac turpis egestas. Suspendisse eget facilisis odio.
                                                Duis
                                                sodales
                                                augue eu tincidunt faucibus. Etiam justo ligula, placerat ac augue
                                                id,
                                                volutpat
                                                porta dui.</p>
                        ...
                        <div class="product-item__outer h-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="{{ route('client.products.category', ['categorySlug' => $related->category->slug]) }}"

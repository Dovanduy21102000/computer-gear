            ...
            <div class="my-md-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                        <<<<<<< HEAD <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a
                    ...
                    <div id="Description" class="mx-md-2">
                        ...
                        <div class="mx-md-4 pt-1">
                            ...
                            <ul class="nav flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                                <li class="nav-item text-gray-111 flex-shrink-0 flex-xl-shrink-1"><strong>SKU:
                                    </strong> <span class="sku"> FW511948218</span></li>
                            ...
                            <div class="product-item__body pb-xl-2">
                                ...
                                <div class="mb-2">
                                    <a href="{{ route('client.products.detail', $related->slug) }}"
                                        ...
                                        <img class="img-fluid" src="{{ asset('storage/' . $related->thumbnail) }}"
                                            alt="{{ $related->name }}">
                                    </a>
                                </div>
                                <div class="flex-center-between mb-1">

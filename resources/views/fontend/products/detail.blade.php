    ...
    <div class="container">
       ...
       @foreach($product->images as $image)
           <div class="js-slide" style="cursor: pointer;">
               <img class="img-fluid" src="{{ asset('storage/' . $image->path) }}" alt="Image Description">
           </div>
       @endforeach
   </div>
           ...
           <div class="border-bottom mb-3 pb-md-1 pb-3">
               ...
               <div class="mb-2">
                   <a class="d-inline-flex align-items-center small font-size-15 text-lh-1" href="#">
                       ...
                       <span class="text-secondary font-size-13">({{ $product->reviews_count }} customer reviews)</span>
                   </a>
               </div>
               <div class="d-md-flex align-items-center">
                   <a href="#" class="max-width-150 ml-n2 mb-2 mb-md-0 d-block"><img class="img-fluid" src="{{ asset('storage/' . $product->brand->logo) }}" alt="Image Description"></a>
                   <div class="ml-md-3 text-gray-9 font-size-14">Availability: <span class="text-green font-weight-bold">{{ $product->quantity }} in stock</span></div>
               </div>
           </div>
           ...
           <div class="mb-4">
               <div class="d-flex align-items-baseline">
                   ...
                   @if($product->price_sale)
                       <del class="font-size-20 ml-2 text-gray-6">${{ $product->price_sale }}</del>
                   @endif
               </div>
           </div>

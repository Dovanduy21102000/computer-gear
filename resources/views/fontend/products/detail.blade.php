        ...
        <div class="mb-14">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-xl-4 mb-md-6 mb-lg-0">
                    <div class="mb-2">
                        <a href="#" class="font-size-12 text-gray-5 mb-2 d-inline-block"> {{ $product->category->name ?? 'Danh mục' }}</a>
                        ...
                        <a href="#" class="d-inline-block max-width-150 ml-n2 mb-2"><img class="img-fluid"src="{{ asset('storage/' . $product->thumbnail) }}" alt="{{ $product->name }}"></a>
                        <div class="mb-2">
                ...
                <div class="mx-md-auto mx-lg-0 col-md-6 col-lg-4 col-xl-3">
                    <div class="mb-2">
                        <div class="card p-5 border-width-2 border-color-1 borders-radius-17">
                            <div class="text-gray-9 font-size-14 pb-2 border-color-1 border-bottom mb-3">Số lượng: <span class="{{ $product->quantity > 0 ? 'text-green' : 'text-danger' }} font-weight-bold">
                                {{ $product->quantity }}
                            </span> sản phẩm</div>
                            <div class="mb-3">
                                <div class="font-size-24">
                                    @if($product->price_sale)
                                        ...
                                        <span class="text-danger">{{ number_format($product->price_sale, 0, ',', '.') }}₫</span>
                                    @else
                            ...
                            <div class="flex-content-center flex-wrap">
                                <a href="#" class="text-gray-6 font-size-13 mr-2"><i class="ec ec-favorites mr-1 font-size-15"></i> Yêu thích</a>

                                             ...
                                             <li class="u-has-submenu u-header-collapse__submenu">
                                                 ...
                                                 <div id="headerSidebarHomeCollapse" class="collapse"
                                                     ...
                                                     <ul id="headerSidebarHomeMenu" class="u-header-collapse__nav-list">
                                                         ...
                                                         <!-- Store Directory -->
                                                         <li><a class="u-header-collapse__submenu-nav-link"
                                                                 href="store-directory.html">Store Directory</a></li>
                                                         <!-- End Store Directory -->
                                             ...
                                             <li class="u-has-submenu u-header-collapse__submenu">
                                                 ...
                                                 <div id="headerSidebarDemosCollapse" class="collapse"
                                                     ...
                                                     <ul id="headerSidebarDemosMenu"
                                                         ...
                                                         <!-- Cart -->
                                                         <li><a class="u-header-collapse__submenu-nav-link"
                                                                 href="https://transvelo.github.io/electro-html/2.0/html/shop/cart.html">Giỏ
                                                                 hàng</a>
                                                         </li>
                                                         <!-- End Cart -->
                                                         ...
                                                         <!-- My Account -->
                                                         <li><a class="u-header-collapse__submenu-nav-link"
                                                                 href="https://transvelo.github.io/electro-html/2.0/html/shop/my-account.html">Tài
                                                                 khoản của tôi
                                                             </a></li>
                                                         <!-- End My Account -->
                     ...
                     <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                         <ul class="navbar-nav u-header__navbar-nav">
                             ...
                             <li class="nav-item hs-has-mega-menu u-header__nav-item">
                                 <a class="nav-link u-header__nav-link" href="{{ route('products.index') }}">Sản
                                     phẩm</a>
                             </li>
                             <!-- End Pages -->

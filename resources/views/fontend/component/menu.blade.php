                            ...
                            <img src="{{ asset('fontend/assets/img/computergearlogo.png') }}" alt="computergear">
                                                        ...
                                                        <div class="js-scrollbar u-sidebar__body">
                                                            <div id="headerSidebarContent"
                                                                ...
                                                                <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center"
                                                                    ...
                                                                    aria-label="Computer Gear">
                                                                    <svg version="1.1" width="350px" height="60px"
                                                                        viewBox="0 0 350 60"
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        style="margin-bottom: 0;">

                                                                        <text x="10" y="40" font-size="38"
                                                                            fill="#333E48" font-weight="bold"
                                                                            font-family="Arial, sans-serif">COMPUTER
                                                                            GEAR</text>
                                                                    </svg>
                                                                </a>
                                                                <!-- End Logo -->
                                                                ...
                                                                <ul id="headerSidebarList"
                                                                    class="u-header-collapse__nav list-unstyled mb-0">
                                                                    <!-- Item -->
                                                                    ...
                                                                    <li class="u-has-submenu">
                                                                        ...
                                                                        <div class="collapse" id="collapseProducts">
                                                                            <ul class="ml-4 list-unstyled">
                                                                                    ...
                                                                                    if (
                                                                                        ...
                                                                                        function renderCategoryMenu(
                                                                                            ...
                                                                                            foreach (
                                                                                                ...
                                                                                                echo '<li>';
                                                                                                echo '<a class="u-header-collapse__nav-link" href="' .
                                                                                                    route(
                                                                                ...
                                                                                @endphp
                                                                                @php renderCategoryMenu($categories); @endphp
                                                                            </ul>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li class="u-has-submenu">
                                                                        <a class="u-header-collapse__nav-link d-flex align-items-center collapsed"
                                                                            ...
                                                                            data-toggle="collapse" role="button"
                                                                            aria-expanded="false">
                                                                            <i class="fas fa-newspaper mr-2"></i> Bài
                                                                            viết
                                                                            <i class="ml-auto fas fa-chevron-down"></i>
                                                                        </a>
                                                                    ...
                                                                    <li class="u-has-submenu">
                                                                        <a class="u-header-collapse__nav-link d-flex align-items-center"
                                                                            href="{{ route('about-us') }}">
                                                                            <i class="fas fa-users mr-2"></i> Về chúng
                                                                            tôi
                                                                        </a>
                                                                    </li>
                                                                    ...
                                                                    <li class="u-has-submenu">
                                                                        <a class="u-header-collapse__nav-link d-flex align-items-center"
                                                                            ...
                                                                            <i class="fas fa-envelope mr-2"></i> Liên
                                                                            hệ
                                                                        </a>
                                                                    </li>
                                                                    ...
                                                                    <li class="u-has-submenu">
                                                                        <a class="u-header-collapse__nav-link d-flex align-items-center"
                                                                            ...
                                                                            <i class="fas fa-heart mr-2"></i> Danh sách
                                                                            yêu thích
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                        ...
                                        <nav
                                            ...
                                            <div id="navBar"
                                                ...
                                                <ul class="navbar-nav u-header__navbar-nav">
                                                    ...
                                                    <li class="nav-item hs-has-sub-menu u-header__nav-item">
                                                        <a class="nav-link u-header__nav-link "
                                                            href="{{ route('blog.index') }}" aria-haspopup="true"
                                                            aria-expanded="false">Bài viết</a>
                                                    </li>
                                                    <!-- End Blog -->
                                                    <li class="nav-item u-header__nav-item">
                                                        <a class="nav-link u-header__nav-link"
                                                            href="{{ route('about-us') }}">Về chúng
                                                            tôi</a>
                                                    </li>

                                                    <li class="nav-item u-header__nav-item">
                                                        <a class="nav-link u-header__nav-link"
                                                            href="{{ route('faqs') }}">Câu hỏi thường
                                                            gặp</a>
                                                    </li>
                                    ...
                                    <div class="d-none d-xl-block col-md-auto">
                                        <div class="d-flex">
                                            ...
                                            <div class="ml-2">
                                                <div class="phone">
                                                    <strong>Hỗ trợ:</strong> <a href="tel:800856800604" class=""
                                                        style="text-decoration: ">(+800) 856 800
                                                        604</a>
                                                </div>
                                                <div class="email">
                                                    E-mail: <a href="mailto:info@electro.com?subject=Help Need"
                                                        class=""
                                                        style="text-decoration: none">computergear@gmail.com</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <ul class="d-flex list-unstyled mb-0 align-items-center">
                                                ...
                                                <li class="col d-xl-none px-2 px-sm-3 position-static">
                                                    <a id="searchClassicInvoker"
                                                        ...
                                                        aria-controls="searchClassic" aria-haspopup="true"

 ...
 <footer>
     ...
     {{-- <div class="container d-none d-lg-block mb-3">
         <div class="row">
             ...
             <div class="col-wd-3 col-lg-4">
                 <div class="border-bottom border-color-1 mb-5">
                     <h3 class="section-title section-title__sm mb-0 pb-2 font-size-18">Sản phẩm đang bán</h3>
                 </div>
                 <ul class="list-unstyled products-group">
             ...
             <div class="col-wd-3 col-lg-4">
                 <div class="border-bottom border-color-1 mb-5">
                     <h3 class="section-title section-title__sm mb-0 pb-2 font-size-18">Sản phẩm được đánh giá cao nhất
                     </h3>
                 </div>
                 <ul class="list-unstyled products-group">
                     ...
                     <div class="mb-4">
                         <div class="row no-gutters">
                             ...
                             <div class="col pl-3">
                                 ...
                                 <a href="tel:+80080018588" class="font-size-20 text-gray-90">0987654321, </a><a
                                     href="tel:+0600874548" class="font-size-20 text-gray-90">0123456789</a>
                             </div>
                         </div>
                     </div>
                     <div class="mb-4">
             ...
             <div class="flex-center-between d-block d-md-flex">
                 ...
                 <div class="text-md-right">
                     <span class="d-inline-block bg-white border rounded p-1">
                         <img class="max-width-5" src="fontend/assets/img/100X60/img1.jpg" alt="Image Description">
                     </span>
                     <span class="d-inline-block bg-white border rounded p-1">
                         <img class="max-width-5" src="fontend/assets/img/100X60/img2.jpg" alt="Image Description">
                     </span>
                     <span class="d-inline-block bg-white border rounded p-1">
                         <img class="max-width-5" src="fontend/assets/img/100X60/img3.jpg" alt="Image Description">
                     </span>
                     <span class="d-inline-block bg-white border rounded p-1">
                         <img class="max-width-5" src="fontend/assets/img/100X60/img4.jpg" alt="Image Description">
                     </span>
                     <span class="d-inline-block bg-white border rounded p-1">
                         <img class="max-width-5" src="fontend/assets/img/100X60/img5.jpg" alt="Image Description">
                     </span>
                 </div>
             </div>
         </div>
             ...
             <div class="js-scrollbar u-header-sidebar__footer-offset pb-3">
                 ...
                 <div class="js-scrollbar u-sidebar__body" id="footer">
                     ...
                     <div class="u-sidebar__content u-header-sidebar__content">
                         <form class="js-validate" method="POST" action="{{ route('login') }}" id="loginForm"
                             style="display: none;">
                             @csrf
                             <!-- Login -->
                         ...
                         <form method="POST" action="{{ route('register.form') }}" id="signupForm"
                                 ...
                                 <div class="js-form-message js-focus-state">
                                     ...
                                     <div class="input-group">
                                         ...
                                         <input type="password" class="form-control" name="password_confirmation"
                                             id="signupConfirmPassword" placeholder="Confirm Password" required>
                                     </div>
                                 </div>
                             </div>
                             ...
                             <div class="mb-2">
                                 <button type="submit"
                                     class="btn btn-block btn-sm btn-primary transition-3d-hover">Get Started</button>
                             </div>

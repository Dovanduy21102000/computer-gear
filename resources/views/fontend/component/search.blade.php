...
<script>
    ...
    fetch('/cart/count')  // API để lấy số lượng giỏ hàng từ server
...
document.querySelector('.add-to-cart-btn').addEventListener('click', function() {
    ...
    .then(response => response.json())
    .then(data => {
        // Sau khi thêm sản phẩm, cập nhật số lượng giỏ hàng trong header
        updateCartItemCount();
    });
});

// Khi người dùng cập nhật giỏ hàng
document.querySelector('.update-cart-btn').addEventListener('click', function() {
    fetch('/cart/update', {
        method: 'POST',
...
// Khi người dùng xóa sản phẩm khỏi giỏ hàng

                    ...
                    <div class="card border-0 shadow-sm">
                        <article class="card-body">
                            ...
                            <div class="text-center"
                                style="width: 150px; height: 150px; margin: 0 auto; background-color: #f5f5f5; border: 2px solid #ddd; border-radius: 50%; overflow: hidden;">
                                <img class="img-fluid"
                            ...
                            <div class="px-3">
                                <div class="mb-3">
                                    <strong>Email:</strong> <span
                                        style="color: #222; font-weight: bold;">{{ $user->email }}</span>
                                </div>
                                <div class="mb-3">
                                    <strong>Số điện thoại:</strong> <span
                                        style="color: #222; font-weight: bold;">{{ $user->phone }}</span>
                                </div>
                                <div class="mb-3">
                                    <strong>Địa chỉ:</strong> <span
                                        style="color: #222; font-weight: bold;">{{ $user->address ?? 'Chưa cập nhật' }}</span>
                                </div>
                            </div>
                            ...
                            <form action="{{ route('user.save') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address" name="address" class="form-control"
                                        value="{{ $user->address }}" placeholder="Nhập địa chỉ của bạn">
                                </div>
                                <div class="form-group">

            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Form để thêm ảnh -->
                        <form action="{{ route('backend.product_images.store', ['product_id' => $product->id]) }}"
                          ...
                          <a href="{{ route('backend.product_images.index', ['product_id' => $product->id]) }}" class="btn btn-secondary">Quay lại</a>
                      </form>

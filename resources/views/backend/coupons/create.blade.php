...
<form action="{{ route('coupons.store') }}" method="POST">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="number" name="maximum_amount" class="form-control" value="{{ old('maximum_amount') }}">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="number" name="min_order_total" class="form-control" value="{{ old('min_order_total') }}">
        </div>
    </div>

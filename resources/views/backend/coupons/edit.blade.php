                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('coupons.update', $coupon->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="type" class="form-select">
                                        <option value="fixed"
                                            {{ old('type', $coupon->type) == 'fixed' ? 'selected' : '' }}>Số tiền cố
                                            định</option>
                                        <option value="percent"
                                            {{ old('type', $coupon->type) == 'percent' ? 'selected' : '' }}>Phần trăm
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="maximum_amount" class="form-control"
                                        value="{{ old('maximum_amount', $coupon->maximum_amount) }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="min_order_total" class="form-control"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="status" class="form-select">
                                        <option value="1"
                                            {{ old('status', $coupon->status) == 1 ? 'selected' : '' }}>Hoạt động
                                        </option>
                                        <option value="0"
                                            {{ old('status', $coupon->status) == 0 ? 'selected' : '' }}>Không hoạt động
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="is_public">
                                            Công khai (Ai cũng có thể sử dụng mã này một lần)
                                        </label>
                                    </div>
                                    <small class="form-text text-muted">Nếu không chọn, bạn sẽ cần chỉ định người dùng
                                        được nhận mã này.</small>
                                </div>
                            </div>
